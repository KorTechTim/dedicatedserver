...
#===============================================================================
{
 ~/minecraft/java -Xms${MaxMemory} -Xmx${MaxMemory} -jar forge-${MODVersion}-installer.jar nogui
}
...
echo "========================================================================"
echo "java -Xms${MaxMemory}M -Xmx${MaxMemory}M -jar forge-${MODVersion}-installer.jar nogui"
echo
echo
